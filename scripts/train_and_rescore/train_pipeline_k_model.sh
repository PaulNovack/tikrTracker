#!/bin/bash
# Train Pipeline K Model (Scarcity Leaders)
# Morning scarcity/momentum leaders (09:40-10:10)
# Expected: 12000+ alerts
...
TODAY=$(date +%Y-%m-%d)
MODEL_OUT="${MODEL_OUT:-$(get_pipeline_model_path "K" "python_ml/models/winner_model_pipeline_k.joblib")}"
...
echo "=================================================="
echo "Training Pipeline K Model (Scarcity Leaders)"
echo "=================================================="
echo "Start time: $(date)"
echo "Training window: $START_DATE -> $TODAY"
echo "Training scope: all available K alerts from the earliest analyzed row"
echo ""

# Train Pipeline K specific model
...
echo "Next steps:"
echo "1. Update .env:"
echo "   TRADING_ML_PIPELINE_K_MODEL_PATH=$MODEL_OUT"
echo "2. Run: php artisan config:clear"
echo "3. Monitor logs for 'Using Pipeline K specific model'"
