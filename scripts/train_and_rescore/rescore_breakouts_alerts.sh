#!/bin/bash
# Rescore Breakout Model alerts (Pipelines C, D)
...
echo "=================================================="
echo "Rescoring Breakout Alerts (Pipelines C, D)"
echo "=================================================="
echo "Start time: $(date)"
echo ""

for PIPELINE in C D; do
  MODEL_PATH="$(get_pipeline_model_path "$PIPELINE" "python_ml/models/winner_model_breakouts.joblib")"
  echo "--------------------------------------------------"
...
echo ""
echo "=================================================="
echo "Done! All breakout alerts rescored."
echo "End time: $(date)"
echo "=================================================="
