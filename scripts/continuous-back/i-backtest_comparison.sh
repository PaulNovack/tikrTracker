...
# Pipeline I Backtest - Continuous Loop (Single Thread)
...
echo "[startup] Waiting 75s before first iteration…"
sleep 75
...
while true; do
    ...
    LOG_FILE="$LARAVEL_ROOT/storage/logs/backtest-i-${TODAY}.log"
    exec >> "$LOG_FILE" 2>&1
    TIME=$(date +%H:%M:%S)
    ...
    echo "============================================================"
    echo "  PIPELINE I BACKTEST  [Iteration $ITERATION]"
    echo "============================================================"
    echo ""
