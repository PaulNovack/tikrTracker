...
# Pipeline F Backtest - Continuous Loop (Single Thread)
...
echo "[startup] Waiting 45s before first iteration…"
sleep 45
...
while true; do
    ...
    LOG_FILE="$LARAVEL_ROOT/storage/logs/backtest-f-${TODAY}.log"
    exec >> "$LOG_FILE" 2>&1
    ...
    echo "============================================================"
    echo "  PIPELINE F BACKTEST  [Iteration $ITERATION]"
    echo "============================================================"
    echo ""
    echo "Date:      $TODAY"
