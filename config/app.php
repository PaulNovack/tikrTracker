...
return [
    ...
    */
    ...
    'trade_alert_a_version' => env('TRADE_ALERT_A_VERSION', 'v90.1'),
    'trade_alert_b_version' => env('TRADE_ALERT_B_VERSION', 'v120.0'),
    'trade_alert_c_version' => env('TRADE_ALERT_C_VERSION', 'v101.0'),
    'trade_alert_d_version' => env('TRADE_ALERT_D_VERSION', 'v60.3'),
    'trade_alert_e_version' => env('TRADE_ALERT_E_VERSION', 'v400.0'),
    'trade_alert_f_version' => env('TRADE_ALERT_F_VERSION', 'v900.1'),
    'trade_alert_g_version' => env('TRADE_ALERT_G_VERSION', 'v35.0'),
    'trade_alert_h_version' => env('TRADE_ALERT_H_VERSION', 'v25.2'),
    'trade_alert_i_version' => env('TRADE_ALERT_I_VERSION', 'v17.0'),
