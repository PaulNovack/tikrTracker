...
✅ Uses `trade_alerts.pnl_percent` (your actual column)
...
def train_and_eval(
    ...
    drop_cols = {
        ...
        # 🚫 POST-TRADE / LOOKAHEAD
        "hold_time_minutes",

        # 🚫 TRAIN/PROD DISTRIBUTION SHIFT (optional)
...
def main():
    ...
    ap_train.add_argument("--test-size", type=float, default=0.2,
                          help="Time-based holdout fraction for evaluation (e.g. 0.2 = last 20% is test). Use 0 for no split.")
