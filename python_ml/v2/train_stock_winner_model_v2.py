...
FEATURE_COLUMNS = [
    ...
    "failed_rally_count",
    # enriched alert-side features — fully populated at entry time on trade_alerts
    # (added 2026-08-01; mirrored in score_single_alert_v2.py, scoring_daemon.py,
    #  and score_single_alert_live.py so train/score stay in sync)
    "move_30m_pct",
    "rvol_5m",
    "atr_pct_5m",
    "notional_last5m",
...
SELECT
    ...
    t.avg_dollar_volume_per_minute,
    t.sentiment_score_1_100,
    t.pipeline_run,
    t.version,
