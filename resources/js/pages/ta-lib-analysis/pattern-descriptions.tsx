...
export const PATTERN_DESCRIPTIONS: Record<string, PatternInfo> = {
    ...
    CDL3WHITESOLDIERS: {
        ...
        subtitle: 'A powerful bullish reversal pattern',
        description:
            'The Three White Soldiers (also known as Three Advancing White Soldiers) is a three-candle bullish reversal pattern appearing at the bottom of a downtrend. Three consecutive long-bodied white candles, each opening within the prior candle\'s body and closing at or near its high, signal overwhelming bullish momentum taking control from sellers.',
        structure: [
            'Three consecutive long-bodied white (green) candles',
            'Each opens within the prior candle\'s real body',
            'Each closes at or near its session high',
            'Small or no upper shadows — sustained buying all session',
            'Volume tends to increase through the pattern',
        ],
        interpretation: [
            'Signals a decisive shift from bearish to bullish control',
            'Each candle shows buyers dominating the entire session',
            'Opposite of Three Black Crows — marks a potential bottom',
            'Most reliable after a prolonged downtrend or at support levels',
        ],
        confirmation:
            'Traders often wait for a higher close or breakout above the third candle\'s highs on the next bar before entering long positions.\n\n'
            + '- **Surging Volume:** Volume must increase on each of the three bars to confirm institutional buying.\n'
            + '- **Moving Average Support:** The pattern should form right at or breakout above the **9 EMA** or **20 EMA**.\n'
            + '- **RSI Room to Run:** The Relative Strength Index (RSI) should be rising but still **below 70** to avoid overbought traps',
    },
    CDLABANDONEDBABY: {
        title: 'Abandoned Baby',
        subtitle: 'A rare and powerful reversal pattern',
        description:
            'The Abandoned Baby is a rare three-candle reversal pattern. A doji gaps away from the prior candle, then the third candle gaps in the opposite direction and closes well into the first candle\'s body.',
        structure: [
    ...
    CDLBELTHOLD: {
        ...
        description:
            'The Belt-hold is a single long candle that opens at (or near) its high (bearish) or low (bullish) and closes at the opposite extreme.',
        structure: [
    ...
    CDLDRAGONFLYDOJI: {
        ...
        subtitle: 'A bullish reversal signal',
        description:
            'The Dragonfly Doji is a rare single-candle bullish reversal pattern that signals a potential shift from bearish to bullish sentiment. Its small body and long lower shadow indicate sellers were overwhelmed by buyers.',
        structure: [
            'Open, high, and close at or near the same price level',
            'Little to no upper shadow',
            'Very long lower shadow, typically 2-3x the body or more',
            'Most significant at the bottom of a downtrend',
        ],
        interpretation: [
            'Sellers pushed price significantly lower during the session',
            'Buyers aggressively stepped in at the lows and drove price back to the open',
            'Represents a rejection of lower prices and a potential bottom',
            'The longer the lower shadow, the more bullish the signal',
        ],
        confirmation:
            'Traders typically wait for a follow-up green confirmation candle closing higher before executing trades.',
    },
    CDLENGULFING: {
    ...
    CDLMORNINGSTAR: {
        title: 'Morning Star',
        subtitle: 'A three-candle bullish reversal pattern',
        description:
            'The Morning Star is a three-candle pattern signaling a reversal from a downtrend. A large black candle is followed by a small-bodied candle that gaps lower, then a large white candle drives back above the midpoint of the first, confirming the reversal.',
        structure: [
            'First candle: long black candle in a downtrend',
            'Second candle: small-bodied candle that gaps below the first candle',
            'Third candle: long white candle that closes above the midpoint of the first',
        ],
        interpretation: [
            'The first candle shows strong selling pressure continuing the trend',
            'The second small candle represents indecision or pause in momentum',
            'The third white candle confirms a shift in sentiment toward buyers',
        ],
        confirmation:
            'Confirmation occurs when the third candle closes above the midpoint of the first. Additional volume on the third candle strengthens the signal.',
    },
    CDLONNECK: {
    ...
    CDLSHOOTINGSTAR: {
        ...
        subtitle: 'A bearish reversal at the top',
        description:
            'The Shooting Star looks like an inverted Hammer at the top of an uptrend. A small body at the lower end with a long upper shadow — buyers pushed higher but were slammed back down.',
        structure: [
            'Small real body at the lower end of the session',
            'Long upper shadow — at least 2x the body length',
            'Little or no lower shadow',
    ...
    CDLUPSIDEGAP2CROWS: {
        ...
        subtitle: 'A bearish reversal pattern',
        description:
            'The Upside Gap Two Crows is a three-candle bearish reversal. After a gap up, two black candles appear — the first fills some of the gap and the second engulfs the first, suggesting the gap up was a trap.',
        structure: [
            'First candle: long white candle',
            'Second candle: black candle that gaps above the first but closes lower',
            'Third candle: black candle that engulfs the second',
        ],
        interpretation: [
            'The gap up looks bullish but the two crows show sellers taking over',
            'The third candle engulfing the second shows increasing selling pressure',
            'Signals that the gap was a blow-off top',
        ],
        confirmation:
            'Traders look for a close below the third candle\'s low or a break of the gap support.',
    },
    CDLXSIDEGAP3METHODS: {
        title: 'Upside/Downside Gap Three Methods',
        subtitle: 'A gap-based continuation pattern',
        description:
            'The Gap Three Methods pattern combines a gap with the Three Methods structure — a gap followed by three small candles that fail to close the gap, then a strong continuation candle in the direction of the gap.',
        structure: [
            'First candle: creates a gap in the trend direction',
            'Three small candles that fail to close the gap',
            'Fifth candle: strong same-direction candle confirming continuation',
        ],
        interpretation: [
            'The inability to close the gap shows the trend is firmly in control',
            'The consolidation within the gap is healthy, not a reversal',
            'The fifth candle confirms the gap will hold as support/resistance',
        ],
        confirmation:
            'Traders enter on the fifth candle, placing stops below (bullish) or above (bearish) the gap.',
    },
};

export function PatternDescriptionCard({ pattern }: { pattern: string }) {
