...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Scheduler Log', href: '/logs/scheduler' },
]
...
export default function SchedulerLog() {
    ...
    const runSearch = useCallback(async (query: string) => {
        ...
        try {
            const response = await fetch(`/api/logs/scheduler/search?q=${encodeURIComponent(query)}&context=6`);
    ...
    const fetchLog = async () => {
        try {
            const response = await fetch('/api/logs/scheduler?lines=500');
    ...
    const handleDownload = () => {
        ...
        a.href = url;
        a.download = filename || 'laravel-scheduled.log';
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Scheduler Log" />
            <Card>
                <CardHeader>
                    <div className="flex items-center justify-between">
                        <div>
                            <CardTitle>Laravel Scheduler Log</CardTitle>
                            <CardDescription>
