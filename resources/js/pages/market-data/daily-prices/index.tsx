...
export default function DailyPricesIndex({ prices, filters }: Props) {
    ...
    const fetchSymbols = async (search: string) => {
        ...
        try {
            ...
            const response = await fetch(
                `/market-data/daily-prices/symbols?${params}`,
            );
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-6">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Daily OHLC price data for stocks and cryptocurrencies
                    </p>
                </div>
                                ...
                                {prices.data.length === 0 ? (
                                    ...
                                    prices.data.map((price) => (
                                        ...
                                        >
                                            ...
                                            >
                                                {typeof price.price_change_percent ===
                                                    'number' &&
                                                price.price_change_percent !==
                                                    null
