...
class MarketYfinanceStocks5minBatch extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'market:yfinance-stocks-5min-batch 
     ...
     * @var string
     */
    protected $description = 'Fetch 5-minute stock data using optimized batch requests (multiple symbols per API call)';
    ...
    public function handle(): int
    {
        ...
        $this->info('🚀 Starting optimized batch 5-minute stock sync');
        ...
        $pythonScript = base_path('python/yfinance_stocks_5min_batch.py');
        $command = [
            'python',
            $pythonScript,
            (string) $hours,
