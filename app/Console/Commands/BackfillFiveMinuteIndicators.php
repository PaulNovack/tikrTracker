...
class BackfillFiveMinuteIndicators extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'backfill:five-minute-indicators
                            ...
                            {--table=five_minute_prices : Target table (five_minute_prices or five_minute_prices_full)}';
     ...
     * @var string
     */
    protected $description = 'Backfill technical indicators (VWAP, EMA, ATR) for existing five_minute_prices records';
    ...
    public function handle(): int
    {
        ...
        $this->info('🚀 Starting five_minute_prices technical indicators backfill');
        $this->info('');

        // Build command arguments
        $pythonScript = base_path('python/backfill_five_minute_indicators.py');
        ...
        $table = $this->option('table') ?: 'five_minute_prices';
        $command[] = "--table={$table}";
