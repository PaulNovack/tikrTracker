 ...
 */
class FiveMinuteSignalScannerV90_0
{
    use HasPriceTables;
    ...
    public function scan(
        ...
        $topN = (int) config('trading.v90.entry_score_limit', 80);
        $minYesterdayMove = (float) config('trading.v90.min_yesterday_move', 5.0);
        $minVolMult = (float) config('trading.v90.min_vol_mult', 1.5);
...
SELECT
  ...
  atr_pct
FROM with_metrics
WHERE move_from_open_pct >= 1.0
  AND (vol_ratio >= 0.8 OR avg_vol_20bars IS NULL)
  AND close >= vwap * 0.98
