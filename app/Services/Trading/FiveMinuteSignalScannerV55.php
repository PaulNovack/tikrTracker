...
/**
 * Version 55 - Five-minute Trend Compression Continuation scanner.
 *
 ...
 */
class FiveMinuteSignalScannerV55
{
    use HasPriceTables;

    private string $version = 'v55';

    private string $name = 'Trend Compression Continuation';
    ...
    public float $maxAtrPct5m = 2.40;

    public float $minRecentRvol5m = 1.00;
    ...
    public float $minCompressionRatio = 0.15;

    public float $maxCompressionRatio = 0.95;
    ...
    public float $maxDistanceFromEma9Atr = 1.60;
    ...
    {
        $cacheKey = 'scan_v55:universe_symbols';
