...
/**
 * Version 18.0 - Multi-Timeframe Breakout Confirmation Entry Finder
 * Base: V17.0
 * Purpose: Add 5-minute breakout confirmation to reduce false signals
 *
 * v18.0 changes:
 * - NEW: Validate 1m price ABOVE recent 5m high before accepting entry
 * - NEW: Require strong bullish 5m body (>0.3%)
 * - Expected: Fewer entries but higher quality (avoid fake breakouts)
 *
 * Base v17.0 features:
 * - Loosened filters for more picks (VWAP 3.0 score, vol 1.5x min)
 * - Fresh entries only (6 minutes max age)
 * - Multiple entry patterns: VWAP_RECLAIM, BULL_FLAG, MA_SQUEEZE, EMA bounces
 */
class OneMinuteEntryFinderV18_0
{
    use HasPriceTables;
    ...
    public function findBestLong(
        ...
        // v18.0: NEW - Apply 5-minute breakout confirmation
        // Only accept entries where 1m price is ABOVE recent 5m high (true breakout)
        // This filters out entries that are just chasing pullbacks or noise
