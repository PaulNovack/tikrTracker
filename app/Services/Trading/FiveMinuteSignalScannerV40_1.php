...
/**
 * Version 40.1 - Runner Scanner (unchanged from V40.0)
 ...
 * Partners with OneMinuteEntryFinderV40_1 which has wider 7x ATR trailing stops
 */
class FiveMinuteSignalScannerV40_1
{
    use HasPriceTables;
