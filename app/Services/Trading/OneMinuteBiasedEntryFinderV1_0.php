...
/**
 * Version 1.0 - Biased Entry Finder
 * Base: V17.0
 * Purpose: Entry finder for biased pipeline testing
 * Changes: Will be customized for biased analysis
 */
class OneMinuteBiasedEntryFinderV1_0
{
    use HasPriceTables;
    ...
    public function findBestLong(
        ...
        if ($best) {
            ...
            // Ensure minimum 0.7% stop distance, cap at 1.0%
            $minStopPct = 0.7;
            $maxStopPct = 1.0;
